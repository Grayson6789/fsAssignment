...
let contents = fs.readFileSync("./challenges1/info.text","utf8");
console.log(contents)
// Challenge 2:
// Add the names of everyone in your group to the end of the text file.
let myGroup = ["Lucus","Austin", "Andi"];

for(let i=0;i<myGroup.length;i++){
  fs.appedFile("./challenge2/info.txt", '${myGroup[i]},');
}
